...
CREATE TABLE `estoque` (
  ...
  `idLocal` bigint(10) UNSIGNED NOT NULL,
  `qt` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `qtEmprestada` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `patrimonio` int(10) UNSIGNED DEFAULT NULL
...
INSERT INTO `estoque` (`id`, `iditem`, `idLocal`, `qt`, `qtEmprestada`, `patrimonio`) VALUES
(3, 4, 1, 1, 1, 126127),
(7, 5, 1, 24, 0, NULL),
(9, 3, 3, 30, 10, NULL),
(14, 7, 35, 24, 0, NULL),
...
CREATE TABLE `item` (
  ...
  `tipo` enum('Consumo','Permanente') NOT NULL DEFAULT 'Consumo',
  `descricao` mediumtext NOT NULL,
  `link_manual` mediumtext NOT NULL,
  `link_imagem` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
INSERT INTO `item` (`id`, `nome`, `tipo`, `descricao`, `link_manual`, `link_imagem`) VALUES
(2, 'IN2222', 'Consumo', 'diodo x volts', 'https://www.onsemi.com/pdf/datasheet/p2n2222a-d.pdf', 'https://www.direnc.net/2n2222-plastik-kilif-npn-general-purpose-amplifier-60v-08a-04w-250mhz-en-2n-transistors-fairchild-54673-67-B.jpg'),
(3, 'BN2762', 'Consumo', 'transistor xxxddd', '', ''),
(4, 'fonte', 'Permanente', 'fonte simétrica 2 xadfas', '', ''),
(5, 'INA128', 'Consumo', 'Amplificador de instrumentação', 'https://www.ti.com/lit/ds/symlink/ina128.pdf?ts=1722932156096', 'https://br.mouser.com/images/texasinstruments/images/ITP_TI_PDIP-8_P_t.jpg'),
(6, 'DAQ USB6001', 'Permanente', 'Placa de aquisição National Instruments USB6001 - 2 AO  - 8 AI - 8 DI', 'https://www.ni.com/docs/en-US/bundle/usb-6001-specs/resource/374369a.pdf', 'http://s7d5.scene7.com/is/image/ni/04231418?$ni-card-lg$'),
(7, 'TIL78', 'Consumo', 'TIL78 - 5mm Foto Transistor Receptor\nasdf', '', 'https://global.cdn.magazord.com.br/proesi/img/2024/01/produto/3616/til78-5mm-foto-transistor-receptor.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(8, 'BTG6666', 'Consumo', 'transistor 600v', '', ''),
(9, 'BPW83', 'Consumo', 'Foto Transistor Receptor IR', 'https://www.vishay.com/docs/81530/bpw83.pdf', 'https://global.cdn.magazord.com.br/proesi/img/2024/01/produto/3608/bpw83-foto-transistor-receptor-2-1-1.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(10, 'Fonte simétrica', 'Permanente', 'Fonte simétrica blah blah 2', '', 'https://www.comercialgoncalves.com.br/imagens/informacoes/fonte-alimentacao-simetrica-02.webp'),
(11, '2SK2141', 'Consumo', 'Transistor Mosfet, NPN, 600V/6A (TO-220) Isolado', '', 'https://global.cdn.magazord.com.br/proesi/img/2024/01/produto/8972/2sa1837-transistor-2.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(12, 'Estão de solda HK-936A', 'Permanente', 'Estão de solda hikari HK-936A ixi errei', '', 'https://proesi.cdn.magazord.com.br/img/2024/01/produto/3062/hk-936a-esta-o-solda-anal-gica-hikari-esd-60w-220v-01.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(13, 'conector F coaxial', 'Consumo', 'conector F coaxial avemaria', '', 'https://proesi.cdn.magazord.com.br/img/2024/01/produto/2330/092620.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(14, 'MG30G2CL3', 'Consumo', 'Módulo IGBT', '', 'https://proesi.cdn.magazord.com.br/img/2024/01/produto/4064/mg30g2cl3-m-dulo-igbt.jpeg?ims=fit-in/600x600/filters:fill(white)'),
(15, 'HD2400', 'Permanente', 'Multímetro HD2400', '', 'https://proesi.cdn.magazord.com.br/img/2024/01/produto/15311/hd2400.jpeg?ims=fit-in/600x600/filters:fill(white)');
...
(1, 'B119-A01-PT01-CX01', 'Sala B119\r\nArmário 01\r\nPrateleira 01\r\nCaixa 01'),
(2, 'B119-AR01-PT02-CX01', 'Sala b119xxxx\narmário 01\nprateleira 02\ncaixa 01'),
(3, 'A305-AR01-CX33xx', 'Armário 01 sala b305fasdf'),
(31, 'B305-ar01-cx02', ' Bloco b 305a'),
(33, 'B024-ar03', 'B024 armário 03'),
(35, 'asdfs ', ' apodijfas'),
(36, 'A305-ar02-pt02-cx03', ' armário'),
(37, 'B023-GV02-001', ' Gaveteiro grande'),
(38, 'B119-A02-PT03-CX01', ' Sala B119'),
(39, 'B023-AR01-PT03-CX01', ' caixa no labcid'),
(40, 'B024-AR01-PT02-CX03', ' lapro'),
(41, 'B011-pt01', ' nova sala'),
(42, 'B024-AR01-PT02', ' adfasfa'),
(43, 'B024-AR01-PT03', ' adfasfa222'),
(44, 'B024-AR01-PT04', ' adfasfa222'),
(46, 'B024-AR01-PT05', ' adfasfa222 adfa sdfa df'),
(47, 'B024-AR01-PT06', ' adfasfa222'),
(48, 'B024-AR01-PT07', ' adfasfa222'),
(49, 'B024-AR01-PT08', ' fffff'),
(50, 'B024-AR01-PT10', ' pdaojdfpoasijfd ddfffe'),
(51, 'B119-ar05-pt02-cx01', ' Sala b119');
...
CREATE TABLE `movimentacoes` (
  ...
  `idItem` bigint(10) UNSIGNED DEFAULT NULL,
  `idLocalOrigem` bigint(10) UNSIGNED DEFAULT NULL,
  `idLocalDestino` bigint(10) UNSIGNED DEFAULT NULL,
  `idSolicitacao` bigint(10) UNSIGNED DEFAULT NULL,
  `patrimonio` int(10) UNSIGNED DEFAULT NULL,
  `data` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `qt` int(10) UNSIGNED DEFAULT NULL,
  `tipo_movimentacao` enum('emprestimo','devolucao','baixa','movimentacao','adicao','addLocal','addItem','altLocal','altItem','cancela','devolucaoEBaixa') NOT NULL,
...
INSERT INTO `movimentacoes` (`id`, `idUsuario`, `idItem`, `idLocalOrigem`, `idLocalDestino`, `idSolicitacao`, `patrimonio`, `data`, `qt`, `tipo_movimentacao`, `obs`) VALUES
(120, 1, NULL, NULL, NULL, 26, NULL, '2024-09-27 23:04:39', NULL, 'cancela', 'Usuário cancelou solicitação.'),
(121, 1, NULL, NULL, NULL, 25, NULL, '2024-09-27 23:04:43', NULL, 'cancela', 'Usuário cancelou solicitação.'),
(122, 1, NULL, 33, NULL, NULL, NULL, '2024-09-28 01:18:20', NULL, 'altLocal', 'Alteração de local: B024-ar03\r\nDescricao: B024 armário 03\r\n'),
(123, 1, NULL, 51, NULL, NULL, NULL, '2024-09-28 01:19:00', NULL, 'addLocal', 'Novo local: B119-ar05-pt02-cx01\r\nDescricao: Sala b119\r\n'),
(124, 1, 12, NULL, NULL, NULL, NULL, '2024-09-28 01:20:08', NULL, 'addItem', 'Novo item: Estão de solda HK-936A\r\nDescricao: Estão de solda hikari HK-936A\r\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/3062/hk-936a-esta-o-solda-anal-gica-hikari-esd-60w-220v-01.jpeg?ims=fit-in/600x600/filters:fill(white)\r\ndatasheet: \r\n'),
(125, 1, 12, NULL, NULL, NULL, NULL, '2024-09-28 01:20:50', NULL, 'altItem', 'Altera item: Estão de solda HK-936A\nDescricao: Estão de solda hikari HK-936A ixi errei\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/3062/hk-936a-esta-o-solda-anal-gica-hikari-esd-60w-220v-01.jpeg?ims=fit-in/600x600/filters:fill(white)\ndatasheet: \n'),
(126, 1, 13, NULL, NULL, NULL, NULL, '2024-09-28 01:21:26', NULL, 'addItem', 'Novo item: conector F coaxial\r\nDescricao: conector F coaxial\r\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/2330/092620.jpeg?ims=fit-in/600x600/filters:fill(white)\r\ndatasheet: \r\n'),
(127, 1, 13, NULL, NULL, NULL, NULL, '2024-09-28 01:21:36', NULL, 'altItem', 'Altera item: conector F coaxial\r\nDescricao: conector F coaxial avemaria\r\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/2330/092620.jpeg?ims=fit-in/600x600/filters:fill(white)\r\ndatasheet: \r\n'),
(128, 1, 2, 3, 3, NULL, NULL, '2024-09-28 01:23:55', 10, 'adicao', 'compra'),
(129, 1, 2, 3, 3, NULL, NULL, '2024-09-28 01:26:05', 5, 'adicao', 'nova compra'),
(130, 1, 3, 3, 3, NULL, NULL, '2024-09-28 01:28:43', 20, 'adicao', 'nova compra 2'),
(131, 1, 4, 41, 41, NULL, 126135, '2024-09-28 01:29:03', 1, 'adicao', ''),
(132, 1, 2, 3, 49, NULL, NULL, '2024-09-28 01:29:52', 9, 'movimentacao', ''),
(133, 1, 2, 49, 49, NULL, NULL, '2024-09-28 01:30:22', 2, 'baixa', 'defeito'),
(134, 1, 5, 3, 3, NULL, NULL, '2024-09-28 01:47:07', 55, 'adicao', ''),
(135, 1, 6, 35, 35, NULL, 4455666, '2024-09-28 01:47:22', 1, 'adicao', ''),
(136, 1, 6, 35, 35, NULL, 445566, '2024-09-28 01:49:10', 1, 'adicao', ''),
(137, 1, 5, 35, 35, NULL, NULL, '2024-09-28 01:49:22', 10, 'adicao', ''),
(138, 1, 5, 35, 35, NULL, NULL, '2024-09-28 01:49:43', 5, 'baixa', ''),
(139, 1, 6, 35, 35, NULL, 4455666, '2024-09-28 01:50:04', 1, 'baixa', 'defeito'),
(140, 1, 2, 2, 2, NULL, NULL, '2024-09-28 01:50:38', 50, 'baixa', ''),
(141, 1, 7, 33, 35, NULL, NULL, '2024-09-28 01:53:02', 3, 'movimentacao', ''),
(142, 1, 7, 31, 35, NULL, NULL, '2024-09-28 01:53:25', 7, 'movimentacao', ''),
(143, 1, 7, 33, 33, NULL, NULL, '2024-09-28 01:53:36', 1, 'baixa', ''),
(144, 1, 7, 33, 33, NULL, NULL, '2024-09-28 01:53:43', 1, 'baixa', ''),
(145, 1, 7, 31, 35, NULL, NULL, '2024-09-28 01:54:18', 4, 'movimentacao', ''),
(146, 1, 7, 31, 35, NULL, NULL, '2024-09-28 01:54:31', 10, 'movimentacao', ''),
(147, 1, 6, 35, 3, NULL, 445566, '2024-09-28 01:55:00', 1, 'movimentacao', ''),
(148, 1, 6, 3, 35, NULL, 445566, '2024-09-28 01:55:19', 1, 'movimentacao', ''),
(149, 1, 14, NULL, NULL, NULL, NULL, '2024-10-06 22:41:28', NULL, 'addItem', 'Novo item: MG30G2CL3\r\nDescricao: Módulo IGBT\r\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/4064/mg30g2cl3-m-dulo-igbt.jpeg?ims=fit-in/600x600/filters:fill(white)\r\ndatasheet: \r\n'),
(150, 1, 14, NULL, 35, NULL, NULL, '2024-10-06 22:43:50', 30, 'adicao', ''),
(151, 1, 14, NULL, 35, NULL, NULL, '2024-10-06 22:44:17', 10, 'adicao', ''),
(152, 1, 14, 35, 33, NULL, NULL, '2024-10-06 22:45:00', 20, 'movimentacao', ''),
(153, 1, 14, 35, 50, NULL, NULL, '2024-10-06 22:45:10', 20, 'movimentacao', ''),
(154, 1, 14, 50, 35, NULL, NULL, '2024-10-06 22:45:27', 5, 'movimentacao', ''),
(155, 1, 14, 50, 35, NULL, NULL, '2024-10-06 22:45:34', 15, 'movimentacao', ''),
(156, 1, 14, 33, NULL, NULL, NULL, '2024-10-06 22:45:43', 10, 'baixa', ''),
(157, 1, 14, 33, NULL, NULL, NULL, '2024-10-06 22:45:59', 10, 'baixa', ''),
(158, 1, 14, NULL, 50, NULL, NULL, '2024-10-06 22:46:16', 5, 'adicao', ''),
(159, 1, 15, NULL, NULL, NULL, NULL, '2024-10-06 22:47:29', NULL, 'addItem', 'Novo item: HD2400\r\nDescricao: Multímetro HD2400\r\nimg: https://proesi.cdn.magazord.com.br/img/2024/01/produto/15311/hd2400.jpeg?ims=fit-in/600x600/filters:fill(white)\r\ndatasheet: \r\n'),
(160, 1, 15, NULL, 35, NULL, 222222, '2024-10-06 23:35:14', 1, 'adicao', ''),
(161, 1, 15, NULL, 35, NULL, 222222, '2024-10-06 23:40:34', 1, 'adicao', ''),
(162, 1, 15, 35, 33, NULL, 222222, '2024-10-06 23:41:01', 1, 'movimentacao', ''),
(163, 1, 15, 33, 48, NULL, 222222, '2024-10-06 23:41:36', 1, 'movimentacao', ''),
(164, 1, 15, 48, 35, NULL, 222222, '2024-10-06 23:41:58', 1, 'movimentacao', ''),
(165, 1, 15, 35, NULL, NULL, 222222, '2024-10-06 23:44:20', 1, 'baixa', ''),
(166, 1, 15, NULL, 33, NULL, 222223, '2024-10-06 23:44:41', 1, 'adicao', ''),
(167, 1, 15, NULL, 35, NULL, 222222, '2024-10-06 23:45:10', 1, 'adicao', ''),
(168, 1, 15, 33, 35, NULL, 222223, '2024-10-06 23:45:32', 1, 'movimentacao', '');
...
CREATE TABLE `solicitacao` (
  `id` bigint(10) UNSIGNED NOT NULL,
  `idUsuario` bigint(20) UNSIGNED NOT NULL,
  `idEstoque` bigint(10) UNSIGNED NOT NULL,
  ...
  `qtPedida` int(10) UNSIGNED NOT NULL,
  `qtAtendida` int(10) UNSIGNED NOT NULL,
  `qtDevolvida` int(10) UNSIGNED NOT NULL,
  `profResponsavel` tinytext DEFAULT NULL,
  `status` enum('solicitado','atendido','devolvido','cancelado') NOT NULL,
...
INSERT INTO `solicitacao` (`id`, `idUsuario`, `idEstoque`, `dataSolicitacao`, `dataAtendimento`, `dataDevolucao`, `qtPedida`, `qtAtendida`, `qtDevolvida`, `profResponsavel`, `status`, `obs`) VALUES
(25, 1, 9, '2024-09-27 22:49:53', NULL, NULL, 10, 0, 0, NULL, 'cancelado', ''),
(26, 1, 54, '2024-09-27 22:50:51', NULL, NULL, 1, 0, 0, 'daniel lima', 'cancelado', ''),
(27, 1, 52, '2024-09-27 23:08:38', NULL, NULL, 1, 0, 0, 'ponce', 'solicitado', ''),
(28, 1, 48, '2024-09-27 23:08:52', NULL, NULL, 10, 0, 0, NULL, 'solicitado', '');
...
(1, 'cron', 'a:11:{i:1728258962;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1728287773;a:1:{s:21:\"wp_update_user_counts\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1728291361;a:1:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1728293161;a:1:{s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1728294961;a:1:{s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1728330962;a:1:{s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1728330973;a:2:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}s:25:\"delete_expired_transients\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1728330978;a:1:{s:30:\"wp_scheduled_auto_draft_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1728676629;a:1:{s:30:\"wp_delete_temp_updater_backups\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}}i:1728762962;a:1:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}}s:7:\"version\";i:2;}', 'auto'),
(2, 'siteurl', 'http://localhost/WPEstoque', 'on'),
(3, 'home', 'http://localhost/WPEstoque', 'on'),
(4, 'blogname', 'Estoque WebApp', 'on'),
(5, 'blogdescription', '', 'on'),
(6, 'users_can_register', '1', 'on'),
(7, 'admin_email', 'treebeard.eca@gmail.com', 'on'),
...
(41, 'template', 'varia-wpcom', 'on'),
(42, 'stylesheet', 'balasana-wpcom', 'on'),
...
(92, 'admin_email_lifespan', '1738180561', 'on'),
...
(106, 'widget_block', 'a:6:{i:2;a:1:{s:7:\"content\";s:19:\"<!-- wp:search /-->\";}i:3;a:1:{s:7:\"content\";s:187:\"<!-- wp:group -->\n<div class=\"wp-block-group\"><!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Posts recentes</h2>\n<!-- /wp:heading -->\n\n<!-- wp:latest-posts /--></div>\n<!-- /wp:group -->\";}i:4;a:1:{s:7:\"content\";s:71:\"<!-- wp:group -->\n<div class=\"wp-block-group\"></div>\n<!-- /wp:group -->\";}i:6;a:1:{s:7:\"content\";s:71:\"<!-- wp:group -->\n<div class=\"wp-block-group\"></div>\n<!-- /wp:group -->\";}i:7;a:1:{s:7:\"content\";s:307:\"<!-- wp:cover {\"dimRatio\":50,\"minHeight\":438,\"minHeightUnit\":\"px\"} -->\n<div class=\"wp-block-cover\" style=\"min-height:438px\"><span aria-hidden=\"true\" class=\"wp-block-cover__background has-background-dim\"></span><div class=\"wp-block-cover__inner-container\"><!-- wp:loginout /--></div></div>\n<!-- /wp:cover -->\";}s:12:\"_multiwidget\";i:1;}', 'on'),
(107, 'sidebars_widgets', 'a:3:{s:19:\"wp_inactive_widgets\";a:5:{i:0;s:7:\"block-2\";i:1;s:7:\"block-4\";i:2;s:7:\"block-7\";i:3;s:7:\"block-6\";i:4;s:7:\"block-3\";}s:9:\"sidebar-1\";a:0:{}s:13:\"array_version\";i:3;}', 'on'),
...
(10, 9, '_edit_lock', '1725570769:1'),
(13, 14, '_edit_lock', '1722895840:1'),
(14, 16, '_wp_attached_file', '2024/08/Imagem-do-WhatsApp-de-2024-06-11-as-07.40.38_b234607d.jpg'),
(15, 16, '_wp_attachment_metadata', 'a:6:{s:5:\"width\";i:1112;s:6:\"height\";i:697;s:4:\"file\";s:65:\"2024/08/Imagem-do-WhatsApp-de-2024-06-11-as-07.40.38_b234607d.jpg\";s:8:\"filesize\";i:145221;s:5:\"sizes\";a:0:{}s:10:\"image_meta\";a:12:{s:8:\"aperture\";s:1:\"0\";s:6:\"credit\";s:0:\"\";s:6:\"camera\";s:0:\"\";s:7:\"caption\";s:0:\"\";s:17:\"created_timestamp\";s:1:\"0\";s:9:\"copyright\";s:0:\"\";s:12:\"focal_length\";s:1:\"0\";s:3:\"iso\";s:1:\"0\";s:13:\"shutter_speed\";s:1:\"0\";s:5:\"title\";s:0:\"\";s:11:\"orientation\";s:1:\"0\";s:8:\"keywords\";a:0:{}}}'),
(16, 17, '_edit_lock', '1722895878:1'),
(17, 20, '_edit_lock', '1722955725:1'),
(18, 22, '_menu_item_type', 'post_type'),
(19, 22, '_menu_item_menu_item_parent', '0'),
(20, 22, '_menu_item_object_id', '20'),
(21, 22, '_menu_item_object', 'page'),
(22, 22, '_menu_item_target', ''),
(23, 22, '_menu_item_classes', 'a:1:{i:0;s:0:\"\";}'),
(24, 22, '_menu_item_xfn', ''),
(25, 22, '_menu_item_url', ''),
(27, 23, '_menu_item_type', 'post_type'),
(28, 23, '_menu_item_menu_item_parent', '0'),
(29, 23, '_menu_item_object_id', '17'),
...
(57, 3, '_edit_lock', '1724268402:1'),
(61, 31, '_edit_lock', '1724272593:1'),
(62, 22, '_wp_old_date', '2024-08-06'),
(63, 23, '_wp_old_date', '2024-08-06'),
(64, 24, '_wp_old_date', '2024-08-06'),
(65, 34, '_menu_item_type', 'post_type'),
(66, 34, '_menu_item_menu_item_parent', '0'),
(67, 34, '_menu_item_object_id', '31'),
...
(85, 34, '_wp_old_date', '2024-08-21'),
(86, 22, '_wp_old_date', '2024-08-21'),
(87, 23, '_wp_old_date', '2024-08-21'),
(88, 24, '_wp_old_date', '2024-08-21'),
(89, 40, 'footnotes', '');
...
(1, 1, '2024-08-02 16:56:01', '2024-08-02 19:56:01', '<!-- wp:paragraph -->\n<p>Boas-vindas ao WordPress. Esse é o seu primeiro post. Edite-o ou exclua-o, e então comece a escrever!</p>\n<!-- /wp:paragraph -->', 'Olá, mundo!', '', 'publish', 'open', 'open', '', 'ola-mundo', '', '', '2024-08-02 16:56:01', '2024-08-02 19:56:01', '', 0, 'http://localhost/WPEstoque/?p=1', 0, 'post', '', 1),
(2, 1, '2024-08-02 16:56:01', '2024-08-02 19:56:01', '<!-- wp:paragraph -->\n<p>Esta é uma página de exemplo. É diferente de um post no blog porque ela permanecerá em um lugar e aparecerá na navegação do seu site na maioria dos temas. Muitas pessoas começam com uma página que as apresenta a possíveis visitantes do site. Ela pode dizer algo assim:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>Olá! Eu sou um mensageiro de bicicleta durante o dia, ator aspirante à noite, e este é o meu site. Eu moro em São Paulo, tenho um grande cachorro chamado Rex e gosto de tomar caipirinha (e banhos de chuva).</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>...ou alguma coisa assim:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>A Companhia de Miniaturas XYZ foi fundada em 1971, e desde então tem fornecido miniaturas de qualidade ao público. Localizada na cidade de Itu, a XYZ emprega mais de 2.000 pessoas e faz coisas grandiosas para a comunidade da cidade.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>Como um novo usuário do WordPress, você deveria ir ao <a href=\"http://localhost/WPEstoque/wp-admin/\">painel</a> para excluir essa página e criar novas páginas para o seu conteúdo. Divirta-se!</p>\n<!-- /wp:paragraph -->', 'Página de exemplo', '', 'publish', 'closed', 'open', '', 'pagina-exemplo', '', '', '2024-08-02 16:56:01', '2024-08-02 19:56:01', '', 0, 'http://localhost/WPEstoque/?page_id=2', 0, 'page', '', 0),
(3, 1, '2024-08-02 16:56:01', '2024-08-02 19:56:01', '<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Quem somos</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>O endereço do nosso site é: http://localhost/WPEstoque.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Comentários</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Quando os visitantes deixam comentários no site, coletamos os dados mostrados no formulário de comentários, além do endereço de IP e de dados do navegador do visitante, para auxiliar na detecção de spam.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Uma sequência anonimizada de caracteres criada a partir do seu e-mail (também chamada de hash) poderá ser enviada para o Gravatar para verificar se você usa o serviço. A política de privacidade do Gravatar está disponível aqui: https://automattic.com/privacy/. Depois da aprovação do seu comentário, a foto do seu perfil fica visível publicamente junto de seu comentário.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Mídia</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Se você envia imagens para o site, evite enviar as que contenham dados de localização incorporados (EXIF GPS). Visitantes podem baixar estas imagens do site e extrair delas seus dados de localização.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Cookies</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Ao deixar um comentário no site, você poderá optar por salvar seu nome, e-mail e site nos cookies. Isso visa seu conforto, assim você não precisará preencher seus  dados novamente quando fizer outro comentário. Estes cookies duram um ano.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Se você tem uma conta e acessa este site, um cookie temporário será criado para determinar se seu navegador aceita cookies. Ele não contém nenhum dado pessoal e será descartado quando você fechar seu navegador.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Quando você acessa sua conta no site, também criamos vários cookies para salvar os dados da sua conta e suas escolhas de exibição de tela. Cookies de login são mantidos por dois dias e cookies de opções de tela por um ano. Se você selecionar \"Lembrar-me\", seu acesso será mantido por duas semanas. Se você se desconectar da sua conta, os cookies de login serão removidos.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Se você editar ou publicar um artigo, um cookie adicional será salvo no seu navegador. Este cookie não inclui nenhum dado pessoal e simplesmente indica o ID do post referente ao artigo que você acabou de editar. Ele expira depois de 1 dia.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Mídia incorporada de outros sites</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Artigos neste site podem incluir conteúdo incorporado como, por exemplo, vídeos, imagens, artigos, etc. Conteúdos incorporados de outros sites se comportam exatamente da mesma forma como se o visitante estivesse visitando o outro site.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Estes sites podem coletar dados sobre você, usar cookies, incorporar rastreamento adicional de terceiros e monitorar sua interação com este conteúdo incorporado, incluindo sua interação com o conteúdo incorporado se você tem uma conta e está conectado com o site.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Com quem compartilhamos seus dados</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Se você solicitar uma redefinição de senha, seu endereço de IP será incluído no e-mail de redefinição de senha.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Por quanto tempo mantemos os seus dados</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Se você deixar um comentário, o comentário e os seus metadados são conservados indefinidamente. Fazemos isso para que seja possível reconhecer e aprovar automaticamente qualquer comentário posterior ao invés de retê-lo para moderação.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Para usuários que se registram no nosso site (se houver), também guardamos as informações pessoais que fornecem no seu perfil de usuário. Todos os usuários podem ver, editar ou excluir suas informações pessoais a qualquer momento (só não é possível alterar o seu username). Os administradores de sites também podem ver e editar estas informações.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Quais os seus direitos sobre seus dados</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Se você tiver uma conta neste site ou se tiver deixado comentários, pode solicitar um arquivo exportado dos dados pessoais que mantemos sobre você, inclusive quaisquer dados que nos tenha fornecido. Também pode solicitar que removamos qualquer dado pessoal que mantemos sobre você. Isto não inclui nenhuns dados que somos obrigados a manter para propósitos administrativos, legais ou de segurança.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:heading -->\n<h2 class=\"wp-block-heading\">Para onde seus dados são enviados</h2>\n<!-- /wp:heading -->\n\n<!-- wp:paragraph -->\n<p><strong class=\"privacy-policy-tutorial\">Texto sugerido: </strong>Comentários de visitantes podem ser marcados por um serviço automático de detecção de spam.</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:shortcode /-->', 'Política de privacidade', '', 'draft', 'closed', 'open', '', 'politica-de-privacidade', '', '', '2024-08-21 16:26:42', '2024-08-21 19:26:42', '', 0, 'http://localhost/WPEstoque/?page_id=3', 0, 'page', '', 0),
(4, 0, '2024-08-02 16:56:03', '2024-08-02 19:56:03', '<!-- wp:page-list /-->', 'Navegação', '', 'publish', 'closed', 'closed', '', 'navigation', '', '', '2024-08-02 16:56:03', '2024-08-02 19:56:03', '', 0, 'http://localhost/WPEstoque/2024/08/02/navigation/', 0, 'wp_navigation', '', 0),
(9, 1, '2024-08-03 18:35:27', '2024-08-03 21:35:27', '<!-- wp:paragraph -->\n<p>[estoque_locais]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'testes php', '', 'publish', 'closed', 'closed', '', 'testes-php', '', '', '2024-08-04 11:05:19', '2024-08-04 14:05:19', '', 0, 'http://localhost/WPEstoque/?page_id=9', 0, 'page', '', 0),
(10, 1, '2024-08-03 18:35:27', '2024-08-03 21:35:27', '<!-- wp:paragraph -->\n<p>[testShort]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'testes php', '', 'inherit', 'closed', 'closed', '', '9-revision-v1', '', '', '2024-08-03 18:35:27', '2024-08-03 21:35:27', '', 9, 'http://localhost/WPEstoque/?p=10', 0, 'revision', '', 0),
(11, 1, '2024-08-03 18:35:55', '2024-08-03 21:35:55', '<!-- wp:paragraph -->\n<p>[testeShort]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'testes php', '', 'inherit', 'closed', 'closed', '', '9-revision-v1', '', '', '2024-08-03 18:35:55', '2024-08-03 21:35:55', '', 9, 'http://localhost/WPEstoque/?p=11', 0, 'revision', '', 0),
(13, 1, '2024-08-04 11:05:19', '2024-08-04 14:05:19', '<!-- wp:paragraph -->\n<p>[estoque_locais]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'testes php', '', 'inherit', 'closed', 'closed', '', '9-revision-v1', '', '', '2024-08-04 11:05:19', '2024-08-04 14:05:19', '', 9, 'http://localhost/WPEstoque/?p=13', 0, 'revision', '', 0),
(14, 1, '2024-08-04 11:05:59', '2024-08-04 14:05:59', '<!-- wp:paragraph -->\n<p>[estoque_locais]</p>\n<!-- /wp:paragraph -->', 'Locais', '', 'publish', 'closed', 'closed', '', 'locais', '', '', '2024-08-04 11:05:59', '2024-08-04 14:05:59', '', 0, 'http://localhost/WPEstoque/?page_id=14', 0, 'page', '', 0),
(15, 1, '2024-08-04 11:05:59', '2024-08-04 14:05:59', '<!-- wp:paragraph -->\n<p>[estoque_locais]</p>\n<!-- /wp:paragraph -->', 'Locais', '', 'inherit', 'closed', 'closed', '', '14-revision-v1', '', '', '2024-08-04 11:05:59', '2024-08-04 14:05:59', '', 14, 'http://localhost/WPEstoque/?p=15', 0, 'revision', '', 0),
(16, 1, '2024-08-05 18:57:06', '2024-08-05 21:57:06', '', 'Imagem do WhatsApp de 2024-06-11 à(s) 07.40.38_b234607d', '', 'inherit', 'open', 'closed', '', 'imagem-do-whatsapp-de-2024-06-11-as-07-40-38_b234607d', '', '', '2024-08-05 18:57:06', '2024-08-05 21:57:06', '', 0, 'http://localhost/WPEstoque/wp-content/uploads/2024/08/Imagem-do-WhatsApp-de-2024-06-11-as-07.40.38_b234607d.jpg', 0, 'attachment', 'image/jpeg', 0),
(17, 1, '2024-08-05 19:13:40', '2024-08-05 22:13:40', '<!-- wp:paragraph -->\n<p>[estoque_itens]</p>\n<!-- /wp:paragraph -->', 'Itens', '', 'publish', 'closed', 'closed', '', 'itens', '', '', '2024-08-05 19:13:40', '2024-08-05 22:13:40', '', 0, 'http://localhost/WPEstoque/?page_id=17', 0, 'page', '', 0),
(18, 1, '2024-08-05 19:12:57', '2024-08-05 22:12:57', '', 'Itens', '', 'inherit', 'closed', 'closed', '', '17-revision-v1', '', '', '2024-08-05 19:12:57', '2024-08-05 22:12:57', '', 17, 'http://localhost/WPEstoque/?p=18', 0, 'revision', '', 0),
(19, 1, '2024-08-05 19:13:40', '2024-08-05 22:13:40', '<!-- wp:paragraph -->\n<p>[estoque_itens]</p>\n<!-- /wp:paragraph -->', 'Itens', '', 'inherit', 'closed', 'closed', '', '17-revision-v1', '', '', '2024-08-05 19:13:40', '2024-08-05 22:13:40', '', 17, 'http://localhost/WPEstoque/?p=19', 0, 'revision', '', 0),
(20, 1, '2024-08-06 11:48:47', '2024-08-06 14:48:47', '<!-- wp:paragraph -->\n<p>[estoque_estoque]</p>\n<!-- /wp:paragraph -->', 'Estoque', '', 'publish', 'closed', 'closed', '', 'estoque', '', '', '2024-08-06 11:48:47', '2024-08-06 14:48:47', '', 0, 'http://localhost/WPEstoque/?page_id=20', 0, 'page', '', 0),
(21, 1, '2024-08-06 11:48:47', '2024-08-06 14:48:47', '<!-- wp:paragraph -->\n<p>[estoque_estoque]</p>\n<!-- /wp:paragraph -->', 'Estoque', '', 'inherit', 'closed', 'closed', '', '20-revision-v1', '', '', '2024-08-06 11:48:47', '2024-08-06 14:48:47', '', 20, 'http://localhost/WPEstoque/?p=21', 0, 'revision', '', 0),
(22, 1, '2024-08-29 11:35:31', '2024-08-06 17:47:14', ' ', '', '', 'publish', 'closed', 'closed', '', '22', '', '', '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 0, 'http://localhost/WPEstoque/?p=22', 3, 'nav_menu_item', '', 0),
(23, 1, '2024-08-29 11:35:31', '2024-08-06 17:47:14', ' ', '', '', 'publish', 'closed', 'closed', '', '23', '', '', '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 0, 'http://localhost/WPEstoque/?p=23', 4, 'nav_menu_item', '', 0),
(24, 1, '2024-08-29 11:35:31', '2024-08-06 17:47:14', ' ', '', '', 'publish', 'closed', 'closed', '', '24', '', '', '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 0, 'http://localhost/WPEstoque/?p=24', 5, 'nav_menu_item', '', 0),
(31, 1, '2024-08-21 17:36:44', '2024-08-21 20:36:44', '<!-- wp:paragraph -->\n<p>[estoque_solicitacoes]</p>\n<!-- /wp:paragraph -->', 'Solicitações', '', 'publish', 'closed', 'closed', '', 'solicitacoes', '', '', '2024-08-21 17:36:44', '2024-08-21 20:36:44', '', 0, 'http://localhost/WPEstoque/?page_id=31', 0, 'page', '', 0),
(32, 1, '2024-08-21 17:36:44', '2024-08-21 20:36:44', '<!-- wp:paragraph -->\n<p>[estoque_solicitacoes]</p>\n<!-- /wp:paragraph -->', 'Solicitações', '', 'inherit', 'closed', 'closed', '', '31-revision-v1', '', '', '2024-08-21 17:36:44', '2024-08-21 20:36:44', '', 31, 'http://localhost/WPEstoque/?p=32', 0, 'revision', '', 0),
(34, 1, '2024-08-29 11:35:31', '2024-08-21 20:37:13', ' ', '', '', 'publish', 'closed', 'closed', '', '34', '', '', '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 0, 'http://localhost/WPEstoque/2024/08/21/34/', 2, 'nav_menu_item', '', 0),
(36, 1, '2024-08-29 11:33:59', '2024-08-29 14:33:59', '<!-- wp:paragraph -->\n<p>[estoque_gerencia_solicitacoes]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'Gerência de Solicitações', '', 'publish', 'closed', 'closed', '', 'gerencia-de-solicitacoes', '', '', '2024-08-29 11:33:59', '2024-08-29 14:33:59', '', 0, 'http://192.168.15.11/WPEstoque/?page_id=36', 0, 'page', '', 0),
(37, 1, '2024-08-29 11:33:59', '2024-08-29 14:33:59', '<!-- wp:paragraph -->\n<p>[estoque_gerencia_solicitacoes]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p></p>\n<!-- /wp:paragraph -->', 'Gerência de Solicitações', '', 'inherit', 'closed', 'closed', '', '36-revision-v1', '', '', '2024-08-29 11:33:59', '2024-08-29 14:33:59', '', 36, 'http://192.168.15.11/WPEstoque/?p=37', 0, 'revision', '', 0),
(38, 1, '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 'Gerência', '', 'publish', 'closed', 'closed', '', 'gerencia', '', '', '2024-08-29 11:35:31', '2024-08-29 14:35:31', '', 0, 'http://192.168.15.11/WPEstoque/?p=38', 1, 'nav_menu_item', '', 0),
(40, 1, '2024-09-05 17:20:23', '2024-09-05 20:20:23', '<!-- wp:paragraph -->\n<p>[estoque_locais]</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:paragraph -->\n<p>Currículo 2014/1: o estudante deve cumprir 792HA em disciplinas optativas, sendo que:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:list -->\n<ul class=\"wp-block-list\"><!-- wp:list-item -->\n<li>540HA em disciplinas optativas especializadas e ao menos 252HA em uma das linhas (Mecatrônica, Controle, Computação);</li>\n<!-- /wp:list-item -->\n\n<!-- wp:list-item -->\n<li>144HA em disciplinas optativas na área de engenharias (curriculares ou não);</li>\n<!-- /wp:list-item -->\n\n<!-- wp:list-item -->\n<li>108HA em disciplinas optativas complementares;</li>\n<!-- /wp:list-item --></ul>\n<!-- /wp:list -->\n\n<!-- wp:paragraph -->\n<p>Currículo 2023/1: o estudante deve cumprir 738HA em disciplinas optativas, sendo que:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:list -->\n<ul class=\"wp-block-list\"><!-- wp:list-item -->\n<li>540HA em disciplinas optativas especializadas e ao menos 252HA em uma das linhas (Mecatrônica, Controle, Computação);</li>\n<!-- /wp:list-item -->\n\n<!-- wp:list-item -->\n<li>144HA em disciplinas optativas na área de engenharias (curriculares ou não);</li>\n<!-- /wp:list-item -->\n\n<!-- wp:list-item -->\n<li>54HA em disciplinas optativas complementares;</li>\n<!-- /wp:list-item --></ul>\n<!-- /wp:list -->', 'testes php', '', 'inherit', 'closed', 'closed', '', '9-autosave-v1', '', '', '2024-09-05 17:20:23', '2024-09-05 20:20:23', '', 9, 'http://192.168.15.11/WPEstoque/?p=40', 0, 'revision', '', 0);
...
(18, 1, 'wp_user-settings-time', '1722628573'),
(19, 1, 'wp_dashboard_quick_press_last_post_id', '41'),
(20, 1, 'wp_persisted_preferences', 'a:6:{s:4:\"core\";a:1:{s:26:\"isComplementaryAreaVisible\";b:0;}s:9:\"_modified\";s:24:\"2024-10-04T20:12:31.788Z\";s:14:\"core/edit-site\";a:2:{s:12:\"welcomeGuide\";b:0;s:16:\"welcomeGuidePage\";b:0;}s:14:\"core/edit-post\";a:1:{s:12:\"welcomeGuide\";b:0;}s:22:\"core/customize-widgets\";a:2:{s:12:\"welcomeGuide\";b:0;s:12:\"fixedToolbar\";b:0;}s:17:\"core/edit-widgets\";a:2:{s:26:\"isComplementaryAreaVisible\";b:0;s:12:\"welcomeGuide\";b:0;}}'),
(21, 1, 'managenav-menuscolumnshidden', 'a:5:{i:0;s:11:\"link-target\";i:1;s:11:\"css-classes\";i:2;s:3:\"xfn\";i:3;s:11:\"description\";i:4;s:15:\"title-attribute\";}'),
(22, 1, 'metaboxhidden_nav-menus', 'a:1:{i:0;s:12:\"add-post_tag\";}'),
(23, 1, 'nav_menu_recently_edited', '2'),
(24, 1, 'session_tokens', 'a:1:{s:64:\"ad4e6c251d55f8648c3b11fdc80620425cc33201c5c5b833d44045067610ec6c\";a:4:{s:10:\"expiration\";i:1728425807;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:111:\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36\";s:5:\"login\";i:1728253007;}}'),
(25, 1, 'community-events-location', 'a:1:{s:2:\"ip\";s:12:\"192.168.15.0\";}'),
(26, 2, 'nickname', 'daniel lima'),
(27, 2, 'first_name', ''),
(28, 2, 'last_name', ''),
(29, 2, 'description', ''),
...
(1, 'admin', '$P$B6igeh.lY2tEwZnoQuf5QnIwXSSv5R1', 'admin', 'treebeard.eca@gmail.com', 'http://localhost/WPEstoque', '2024-08-02 19:56:01', '', 0, 'admin'),
(2, 'daniel lima', '$P$BOJ7Mzbx7s1GhaCjEkpFrE7Pf5Gjrq/', 'daniel-lima', 'daniel.lima@ufsc.br', '', '2024-08-30 10:58:28', '1725015510:$P$Bw7wvUf2/rbkFk08rx4rrGoMPTzRmH1', 0, 'daniel lima');
...
ALTER TABLE `estoque`
  ...
  ADD KEY `patrimonio` (`patrimonio`) USING BTREE;
...
ALTER TABLE `movimentacoes`
  ...
  ADD KEY `idItem` (`idItem`),
  ADD KEY `idLocalDestino` (`idLocalDestino`),
  ADD KEY `idLocalOrigem` (`idLocalOrigem`),
...
--
ALTER TABLE `movimentacoes`
  MODIFY `id` bigint(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
...
--
ALTER TABLE `wp_options`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1737;
...
--
ALTER TABLE `estoque`
  ADD CONSTRAINT `estoque_ibfk_1` FOREIGN KEY (`iditem`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `estoque_ibfk_2` FOREIGN KEY (`idLocal`) REFERENCES `localizacao` (`id`);

--
-- Constraints for table `movimentacoes`
--
ALTER TABLE `movimentacoes`
  ADD CONSTRAINT `movimentacoes_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `wp_users` (`ID`),
  ADD CONSTRAINT `movimentacoes_ibfk_2` FOREIGN KEY (`idItem`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `movimentacoes_ibfk_3` FOREIGN KEY (`idLocalDestino`) REFERENCES `localizacao` (`id`),
  ADD CONSTRAINT `movimentacoes_ibfk_4` FOREIGN KEY (`idLocalOrigem`) REFERENCES `localizacao` (`id`),
  ADD CONSTRAINT `movimentacoes_ibfk_5` FOREIGN KEY (`idSolicitacao`) REFERENCES `solicitacao` (`id`);

--
-- Constraints for table `solicitacao`
--
ALTER TABLE `solicitacao`
  ADD CONSTRAINT `solicitacao_ibfk_3` FOREIGN KEY (`idUsuario`) REFERENCES `wp_users` (`ID`),
  ADD CONSTRAINT `solicitacao_ibfk_4` FOREIGN KEY (`idEstoque`) REFERENCES `estoque` (`id`);
COMMIT;
